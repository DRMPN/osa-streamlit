# Contributing to osa-streamlit

We welcome you to [check the existing issues](https://github.com/DRMPN/osa-streamlit/issues) for bugs or enhancements to work on.
If you have an idea for an extension to osa-streamlit, please [file a new issue](https://github.com/DRMPN/osa-streamlit/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/DRMPN/osa-streamlit/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

   ```bash
   git clone git@github.com:YourUsername/osa-streamlit.git
   ```
...
Finally, go to the web page of your fork of the osa-streamlit repo, and click
...
If your contribution changes osa-streamlit in any way:
